    ...
    <div className='p-6 space-y-6'>
        ...
        <div className='w-[90%] p-6 mx-auto'>
            ...
            <div className='w-full bg-white border rounded-xl p-10 mt-10 flex flex-col gap-5 items-center border-gray-300'>
                <Image height={80} width={120} className='h-20 w-30 object-cover' src="https://cdn.candu.ai/cdn-cgi/image/width=120px,dpr=2/https://media.candulabs.com/1908/templa.png" alt="roundedimage" />
