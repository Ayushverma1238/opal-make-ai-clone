  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-xl font-bold text-gray-800">Uncategorized</h1>
              ...
              >
                <div className="flex  items-center flex-col sm:flex-row gap-5 sm:justify-between">
                  <div className="flex gap-5">
                    ...
                    >
                      {scenario?.template.templateApps.map(
                        (d: string, i: number) => {
                    ...
                    <div className="">
                      <h1 className="text-lg font-bold wrap-break-word">
                      ...
                      <div className="flex gap-2  text-sm items-center">
                        ...
                        >
                          <MdOutlineDateRange />
                          <span>
                            {dayjs(scenario.createdAt).format("DD MMM YYYY")}
                          </span>
                        </div>
                      </div>
                    </div>
