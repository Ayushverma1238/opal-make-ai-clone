    ...
    <div className='p-6 space-y-6'>
        ...
        <div className='w-[90%] p-6 mx-auto'>
            ...
            <div className='w-full bg-white border rounded-xl p-10 mt-10 flex flex-col gap-5 items-center border-gray-300'>
                <img className='h-30 w-30 object-cover' src="https://cdn.candu.ai/cdn-cgi/image/width=120px,dpr=2/https://media.candulabs.com/1908/webhooks.png" alt="roundedimage" />
